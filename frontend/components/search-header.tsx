...
export function SearchHeader({
  ...
  const [showCategoryFilter] = useState(true);
          ...
          <div className="flex gap-3">
            <div className="relative flex-1 group">
              ...
              <Input
                ...
                className="pl-12 pr-4 h-12 w-full rounded-2xl bg-gray-50/80 hover:bg-gray-50 focus:bg-white w-full border border-gray-200/80 hover:border-gray-300 transition-all duration-300 shadow-sm"
