 ...
 */
export const publishUserCreated = async (userData: any): Promise<void> => {
  await sendMessage(config.userCreatedTopic, {
    event: "USER_CREATED",
    data: userData,
 ...
 */
export const publishUserUpdated = async (userData: any): Promise<void> => {
  await sendMessage(config.userUpdatedTopic, {
    event: "USER_UPDATED",
    data: userData,
    timestamp: new Date().toISOString(),
  });
